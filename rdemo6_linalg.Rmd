...
# We put the basis vectors into a matrix A
entries = c(1,-1,0,1, 2,-1,1,0, -1,-1,1,3)
A = matrix(entries,nrow=4)
A  # Vectors from class example
...
P %*%D%*% t(P)  # P orthogonal so P^-1 = t(P)
...
# We can use the method from class to find the same regression
